...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__profile__ = __webpack_require__(434);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_jquery__ = __webpack_require__(425);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_intl_tel_input__ = __webpack_require__(435);
...
var ProfilePage = (function () {
    function ProfilePage(navCtrl, actionSheetCtrl, camera, global) {
        ...
        this.firstName = 'John';
        this.lastName = 'Smith';
        this.email = 'john_smith@gmail.com';
        this.passowrd = 'qwse2548';
        this.phoneNumber = 9123456789;
        this.address = "Paradeplein,2018 Antwerp ,Belgium";
        this.flag = true;
    ...
    ProfilePage.prototype.ngOnInit = function () {
        var telInput = __WEBPACK_IMPORTED_MODULE_4_jquery___default()("#elemtId");
        var output = __WEBPACK_IMPORTED_MODULE_4_jquery___default()("#output");
    ...
    ProfilePage.prototype.selectImage = function (num) {
        var _this = this;
        ...
        var actionSheet = this.actionSheetCtrl.create({
            ...
            buttons: [
                {
                    text: 'Gallery',
                    handler: function () { _this.get_camera('Gallery', _this.selectedCamera); }
                }, {
                    text: 'Camera',
                    handler: function () { _this.get_camera('Camera', _this.selectedCamera); }
                }, {
                    text: 'Cancel',
                    role: 'cancel',
                    handler: function () { }
    ...
    ProfilePage.prototype.get_camera = function (source, selectCam) {
        var _this = this;
        var options = { quality: 100, destinationType: this.camera.DestinationType.DATA_URL,
...
(function(factory) {
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(425) ], __WEBPACK_AMD_DEFINE_RESULT__ = function($) {
